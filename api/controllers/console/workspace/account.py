...
from services.account_errors import (
    AccountNotFoundError as ServiceAccountNotFoundError,
)
from services.account_errors import (
...
class AccountAvatarApi(Resource):
    ...
    def get(self, request_context: RequestContext):
        ...
        except AvatarFileNotFoundError:
            raise NotFound("Avatar file not found") from None
...
class AccountPasswordApi(Resource):
    ...
    def post(self, request_context: RequestContext):
        ...
        except CurrentAccountPasswordIncorrectError:
            raise CurrentPasswordIncorrectError() from None
        except ServiceAccountNotFoundError:
            raise AccountNotFound() from None
